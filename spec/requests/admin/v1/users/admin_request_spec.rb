  ...
  context "GET /users" do
    ...
    context "without any params" do
      it "should returns all users" do
        ...
        expected_users << login_user.as_json(only: %i(id name profile email))
  ...
  context "POST /users" do
    ...
    context "when valid params" do
      ...
      it "should create an new user" do
        expect do
          post url, headers: auth_header(login_user), params: correct_params
    ...
    context "when invalid params" do
      ...
      it "should not save a new user" do
        expect do
          post url, headers: auth_header(login_user), params: incorrect_params
      ...
      it "should returns error if password is not equal password_confirmation" do
        ...
        post url, headers: auth_header(login_user), params: user_with_password_is_difer
      ...
      it "should return error if email already in use" do
        ...
        post url, headers: auth_header(login_user), params: user_with_email_already_in_use
  ...
  context "PATCH /users" do
    ...
    context "when correct params" do
      ...
      it "should update a user" do
        patch url, headers: auth_header(login_user), params: correct_params
        user_saved.reload
    ...
    context "when incorrect params" do
      ...
      it "should not update" do
        patch url, headers: auth_header(login_user), params: incorect_params
      ...
      it "should return error if change email to email already in use" do
        ...
        patch url, headers: auth_header(login_user), params: user_with_email_already_in_use.to_json
