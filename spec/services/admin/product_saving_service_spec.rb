  ...
  context "when #call" do
    context "sending loaded product" do
      ...
      context "with valid params" do
        ...
        it "should updates product" do
          product.reload
          expect(product.name).to eq "New product"
        end

        it "should updates :productable" do
          game.reload
          expect(game.developer).to eq "New company"
        end

        it "should updates to new categories" do
          product.reload
      ...
      context "with invalid :product params" do
        ...
        it "should raises NotSaveProductError" do
          expect {
        ...
        it "should keeps old categories" do
          service = error_proof_call(product_params, product)
          product.reload
      ...
      context "with invalid :productable params" do
        ...
        it "should NotSavedProductError" do
          expect {
    ...
    context "without loaded product" do
      ...
      context "with valid params" do
        ...
        let(:params) { product_params.merge(category_ids: categories.map(&:id), productable_attributes: game_params) }
        ...
        it "should creates :productable" do
          expect {
            service = described_class.new(params)
            service.call
        ...
        it "should sets created product" do
          service = described_class.new(params)
          service.call
      ...
      context "with invalid :product params" do
        ...
        it "should does not create a new product" do
          expect {
            error_proof_call(params)
          }.to_not change(Product, :count)
        end

        it "should does not create a :productable" do
          expect {
            error_proof_call(params)
          }.to_not change(Game, :count)
        end

        it "should doen not create category association" do
          expect {
            error_proof_call(params)
