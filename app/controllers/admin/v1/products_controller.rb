module Admin::V1
  class ProductsController < ApiController
    ...
    def destroy
      ...
      render_errro fields: @product.errors.messages.merge(product.productable.errors.messages)
    end
    ...
    def productable_params
      productable_type = params[:product][:productable] || @products&.productable_type&.underscore
