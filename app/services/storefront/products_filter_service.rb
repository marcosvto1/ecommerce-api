module Storefront
  class ProductsFilterService
    ...
    def set_pagination_attributes(total_filtered)
      ...
      @pagination.merge!(page: @params[:page], length: @records.size, total: total_filtered, total_pages: total_pages)
    end
    ...
    def filter_records
      ...
      searched.merge! filter_by_prices
